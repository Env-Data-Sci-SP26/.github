...
Navigate to the [Git, GitHub and RStudio Setup Guide](https://github.com/Env-Data-Sci-SP26/.github/blob/main/git-github-rstudio-setup.md) and follow all steps before moving forward with any of the course content.
...
|------|---------------|-------------------------------------------------------------------------------------------------------------------------------|---------------------|
| 1    | 1/19          | Before class: Primers Basics and R Markdown; download R and RStudio<br> Introduction to R, RStudio, RMarkdown<br>  Assignment - None   | N/A                 |
| 2    | 1/26          | Before class: Work with Data<br>  Exploratory data analysis<br>  Assignment - Exploratory Data Analysis (20 points)                     | 2/2                 |
| 3    | 2/2           |  Before class: Visualize Data<br>  Data visualization<br>  Assignment - Bad Plots (20 points)             | 2/9                 |
| 4    | 2/9          | Before class: Tidy Your Data<br>  Introduction to statistical analysis - T-tests, ANOVA<br>  Assignment - T-Tests and ANOVA (20 points) | 2/16                |
...
| 12   | 4/6         | **Introduction to Working with Geospatial Data** Assignment - Geospatial Data and Analysis (20 points)                                                         | 4/20                 |
| 13   | 4/13          | **Introduction to Working with Geospatial Data (cont.)** <br>  Assignment - Geospatial Visualization (20 points)                            | 4/20               |
